...
<form id="form2" runat="server">
  ...
  <div class="containerconteudo">
    <div class="container-lista-presente-bg">
      <div class="container-lista-presente">
          ...
          <div class="acoes-lista-presente">
              ...
              <ciac:link id="MinhasListas" runat="server"></ciac:link>
           	 <a target="_self" href="http://www.completapravoce.com.br/noivos/" style="display: block;float: none;text-align: center;">
				<img border="0" src="imagens/bt_loja_fisica.png" alt="Cadastro de Lista">
				</a>
